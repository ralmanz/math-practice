      ...
      subtopics: [
        {
          ...
          walkthrough: [
            ...
            { col: 'calc',   type: 'write', html: '<div class="calc-sep"></div><div class="calc-line"><span class="amb">3 + 8 − 2</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-07.mp3', note: { type: 'diagram', label: 'último: suma/resta', diagram: ['P','A','M/D','S/R'], active: 'S/R', text: 'Suma y resta al final, de izquierda a derecha: 3 + 8 \u2212 2.' }, railLabel: 'Último: suma/resta' },
