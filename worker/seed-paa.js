      ...
      subtopics: [
        {
          ...
          walkthrough: [
            ...
            { col: 'calc',   type: 'write', html: '<div class="calc-line"><span class="red">(6 ÷ 3)</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-03.mp3', note: { type: 'diagram', label: 'primero: paréntesis', diagram: ['P','A','M/D','S/R'], active: 'P', meaning: 'Par\u00e9ntesis: primero lo que est\u00e1 entre ( ).', hint: 'Busquemos par\u00e9ntesis. En esta expresi\u00f3n tenemos (6 \u00f7 3); resu\u00e9lvelo primero.' }, railLabel: 'Primero: paréntesis' },
            ...
            { col: 'calc',   type: 'write', html: '<div class="calc-sep"></div><div class="calc-line"><span class="blu">4 × 2</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-05.mp3', note: { type: 'diagram', label: 'siguiente: mult/div', diagram: ['P','A','M/D','S/R'], active: 'M/D', meaning: 'Multiplicaci\u00f3n y divisi\u00f3n: mismo nivel; de izquierda a derecha.', hint: 'Ahora toca multiplicaci\u00f3n o divisi\u00f3n. Aqu\u00ed resolvemos 4 \u00d7 2 antes de sumar o restar.' }, railLabel: 'Siguiente: mult/div' },
            ...
            { col: 'calc',   type: 'write', html: '<div class="calc-sep"></div><div class="calc-line"><span class="amb">3 + 8 − 2</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-07.mp3', note: { type: 'diagram', label: 'último: suma/resta', diagram: ['P','A','M/D','S/R'], active: 'S/R', meaning: 'Suma y resta: mismo nivel; de izquierda a derecha.', hint: 'Por \u00faltimo, suma y resta de izquierda a derecha: 3 + 8 \u2212 2.' }, railLabel: 'Último: suma/resta' },
