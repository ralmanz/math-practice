      ...
      subtopics: [
        {
          ...
          walkthrough: [
            ...
            { col: 'prob',   type: 'write', html: '3 + 4 × 2 − (6 ÷ 3)', pause: 2000, audio: 'paa-arit-n1-02.mp3', note: { type: 'legend', label: 'Qu\u00e9 significa cada letra', lines: [{ chip: 'P', text: 'Par\u00e9ntesis: primero lo que est\u00e1 entre ( ).' }, { chip: 'A', text: 'Potencias: exponentes (², ³, ^\u2026) antes de multiplicar o dividir.' }, { chip: 'M/D', text: 'Multiplicaci\u00f3n y divisi\u00f3n: mismo nivel; de izquierda a derecha.' }, { chip: 'S/R', text: 'Suma y resta: mismo nivel; de izquierda a derecha.' }] }, railLabel: 'El problema' },
