...
(function () {
  ...
  var CSS = [
    ...
    '}',
    '#nav-root .nav-logo .logo-math { color: var(--nuvo-action, #2563EB); font-weight: 700; }',
    ...
    '#nav-root .nav-menu-btn[aria-expanded="true"] { border-color: var(--nuvo-action, #2563EB); background: var(--nuvo-action-bg, #EFF6FF); }',
    ...
    '#nav-root .nav-menu-item--danger { color: var(--text, #111827); }',
    '#nav-root .nav-menu-item--danger:hover { background: #F3F4F6; }',
    ...
    '  background: var(--nuvo-action, #2563EB); color: #fff; border-radius: 8px;',
    '  font-size: 0.9rem; font-weight: 600; text-decoration: none;',
    '  transition: background 0.15s; white-space: nowrap;',
    '}',
    '#nav-root .nav-practicar:hover { background: var(--nuvo-action-dark, #1E40AF); }',
  ].join('\n');
  ...
  var menuOutsideClickBound = false;
  ...
  function wireMenu(panelHtml) {
    ...
    if (btn.dataset.nuvoMenuWired === '1') return;
    btn.dataset.nuvoMenuWired = '1';
    ...
    if (!menuOutsideClickBound) {
      ...
      document.addEventListener('click', function () {
        ...
        var p = document.getElementById('nav-menu-panel');
        if (!b || !p) return;
