...
(function () {
  ...
  var CSS = [
    ...
    '  border-color: var(--nuvo-action, #2563EB); background: var(--nuvo-action-bg, #EFF6FF);',
    '}',
    '.lesson-phase-step.is-current {',
    '  border-color: var(--nuvo-action, #2563EB); background: var(--nuvo-action-bg, #EFF6FF);',
    '}',
    '.lesson-phase-step.is-done:not(.is-current) {',
    '  border-color: var(--nuvo-correct-light, #D8F3DC); background: var(--nuvo-correct-bg, #F0FAF3);',
    '}',
    '.lesson-phase-num {',
    ...
    '  background: var(--nuvo-action, #2563EB); color: #fff;',
    '}',
    '.lesson-phase-step.is-done .lesson-phase-num {',
    '  background: var(--nuvo-correct, #2D6A4F); color: #fff;',
    '}',
    '.lesson-phase-label {',
    ...
    '  color: var(--nuvo-action-dark, #1E40AF);',
    '}',
    '.lesson-phase-step.is-done:not(.is-current) .lesson-phase-label {',
    '  color: var(--nuvo-correct, #2D6A4F);',
    '}',
  ].join('\n');
